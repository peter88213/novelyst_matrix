...
[Download the latest release (version 0.3.1)](https://github.com/peter88213/novelyst_matrix/raw/main/dist/novelyst_matrix_v0.3.1.zip)

- Unzip the downloaded zipfile "novelyst_matrix_v0.3.1.zip" into a new folder.
