...
[Download the latest release (version 2.0.4)](https://github.com/peter88213/novelyst_matrix/raw/main/dist/novelyst_matrix_v2.0.4.zip)

- Extract the "novelyst_matrix_v2.0.4" folder from the downloaded zipfile "novelyst_matrix_v2.0.4.zip".
