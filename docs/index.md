...
[Download the latest release (version 1.1.3)](https://github.com/peter88213/novelyst_matrix/raw/main/dist/novelyst_matrix_v1.1.3.zip)

- Extract the "novelyst_matrix_v1.1.3" folder from the downloaded zipfile "novelyst_matrix_v1.1.3.zip".
