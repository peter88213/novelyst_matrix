...
[Download the latest release (version 1.0.2)](https://github.com/peter88213/novelyst_matrix/raw/main/dist/novelyst_matrix_v1.0.2.zip)

- Unzip the downloaded zipfile "novelyst_matrix_v1.0.2.zip" into a new folder.
