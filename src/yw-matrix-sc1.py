...
from nvmatrixlib.scroll_frame import ScrollFrame
...
class ywMatrix(MainTk):
    ...
    def open_project(self, fileName):
        ...
        if self.novel is not None:
            self._matrixWindow = ScrollFrame(self.mainWindow)
            self._matrix = Matrix(self._matrixWindow.viewPort, self.novel)
